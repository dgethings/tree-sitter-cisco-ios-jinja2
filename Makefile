...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/cisco-ios-jinja2 '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/cisco-ios-jinja2
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/cisco-ios-jinja2
...
.PHONY: all install uninstall clean test list
